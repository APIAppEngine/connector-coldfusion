 ...
 */
public class GetInfoCallable implements GridPlainCallable
{
    ...
    public GetInfoCallable(byte[] file, Map options) {
        this.file = file;
    ...
    public MapResult call() throws Exception {
        ...
        try {
            ...
            //e.printStackTrace();
            throw new ColdFusionException("Error Invoking GetInfo Service on grid", e);
        }
    }
}
