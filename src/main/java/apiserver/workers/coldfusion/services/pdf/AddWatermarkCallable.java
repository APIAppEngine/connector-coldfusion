 ...
 */
public class AddWatermarkCallable implements GridPlainCallable
{
    ...
    public AddWatermarkCallable(byte[] file, Map options) {
        this.file = file;
    ...
    public ByteArrayResult call() throws Exception {
        ...
        try {
            ...
            System.out.println("Invoking Grid Service: api-pdf.cfc::addWatermark ");
            ...
            byte[] result = (byte[])proxy.invoke("addWatermark", new Object[]{base64File, this.options});
            ...
            //e.printStackTrace();
            throw new ColdFusionException("Error Invoking AddWatermark Service on grid", e);
        }
    }
}
