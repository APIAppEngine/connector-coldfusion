...
public class OptimizePdfCallable implements GridPlainCallable
{
    ...
    public OptimizePdfCallable(byte[] file, Map options) {
        this.file = file;
    ...
    public ByteArrayResult call() throws Exception {
        ...
        try {
            ...
            System.out.println("Invoking Grid Service: api-pdf.cfc::optimizePdf ");
            ...
            byte[] result = (byte[])proxy.invoke("optimizePdf", new Object[]{base64File, this.options});
            ...
            //e.printStackTrace();
            throw new ColdFusionException("Error Invoking OptimizePDF Service on grid", e);
        }
    }
}
