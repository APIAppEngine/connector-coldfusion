...
public class DeletePagesCallable implements GridCallable
{
    ...
    public DeletePagesCallable(byte[] file, Map options) {
        this.file = file;
    ...
    public ByteArrayResult call() throws Exception {
        ...
        try {
            ...
            System.out.println("Invoking Grid Service: api-pdf.cfc::deletePages ");
            ...
            byte[] result = (byte[])proxy.invoke("deletePages", new Object[]{base64File, this.options});
            ...
            //e.printStackTrace();
            throw new ColdFusionException("Error Invoking DeletePages Service on grid", e);
        }
    }
}
