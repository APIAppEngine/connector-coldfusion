 ...
 */
public class RemoveWatermarkCallable implements GridPlainCallable
{
    ...
    public RemoveWatermarkCallable(byte[] file, Map options) {
        this.file = file;
    ...
    public ByteArrayResult call() throws Exception {
        ...
        try {
            ...
            System.out.println("Invoking Grid Service: api-pdf.cfc::removeWatermark ");
            ...
            byte[] result = (byte[])proxy.invoke("removeWatermark", new Object[]{base64File, this.options});
            ...
            //e.printStackTrace();
            throw new ColdFusionException("Error Invoking RemoveWatermark Service on grid", e);
        }
    }
}
