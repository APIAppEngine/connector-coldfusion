 ...
 */
public class SetInfoCallable implements GridPlainCallable
{
    ...
    public SetInfoCallable(byte[] file, Map options) {
        this.file = file;
    ...
    public ByteArrayResult call() throws Exception {
        ...
        try {
            ...
            System.out.println("Invoking Grid Service: api-pdf.cfc::setInfo ");
            ...
            String result = (String)proxy.invoke("setInfo", new Object[]{base64File, this.options});
            ...
            //e.printStackTrace();
            throw new ColdFusionException("Error Invoking SetInfo Service on grid", e);
        }
    }
}
